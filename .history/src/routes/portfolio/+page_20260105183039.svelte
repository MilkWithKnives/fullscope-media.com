								...
								<div class="relative z-10">
									...
									<div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
										...
										<div class="absolute top-6 right-6 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
											<div class="bg-gradient-to-r from-[var(--color-primary-strong)] to-[var(--color-primary)] text-black px-4 py-2 rounded-2xl text-xs font-bold shadow-xl border border-zinc-700 animate-result-glow">
												{item.results}
											</div>
										</div>
										...
										<div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700 transform group-hover:scale-100 scale-75">
											<a
												...
												class="bg-black/50 backdrop-blur-md rounded-2xl p-6 border border-zinc-700 animate-pulse-gentle shadow-2xl flex items-center space-x-3 text-white"
											>
								...
								<div class="p-8 space-y-6">
									<div class="space-y-3">
										<div class="flex items-start justify-between">
											...
											<div class="flex items-center space-x-1 text-sm text-zinc-400 ml-4">
												<Calendar size={14} />
									...
									<div class="flex flex-wrap gap-2">
										{#each item.tags as tag}
											<span class="inline-flex items-center space-x-1 px-3 py-1.5 bg-zinc-800 text-zinc-200 text-xs rounded-full border border-zinc-700 hover:bg-[var(--color-primary)] hover:text-black transition-colors duration-300">
												<Tag size={10} />
												<span>{tag}</span>
											</span>
										{/each}
