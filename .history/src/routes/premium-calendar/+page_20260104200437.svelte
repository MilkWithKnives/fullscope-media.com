		...
		<div class="max-w-4xl mx-auto">
			<div class="text-center mb-8">
				<div class="flex items-center justify-center gap-2 mb-4">
					<Star class="w-6 h-6 text-[var(--color-primary)]" />
					<h1 class="text-3xl font-bold text-white">Premium Calendar Demo</h1>
				</div>
				<p class="text-zinc-400">Click on any event to see the interactive modal!</p>
			</div>
