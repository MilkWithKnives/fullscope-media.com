...
- Scheduling: Acuity Scheduling embed
...
- [x] **Acuity Scheduling Embed** - Integrated booking iframe with instant confirmations
...
#### 6. **Studio Booking Experience**
- **Status:** In Progress (Validation Needed)
- **Complexity:** Medium
- **Time Estimate:** 3-4 hours
- **Description:** Ensure Acuity-driven studio bookings cover all scenarios
- **Tasks:**
  - [ ] Confirm embed styling matches brand guidelines
  - [ ] Document how studio-specific services map inside Acuity
  - [ ] Verify email confirmations and calendar invites
  - [ ] Provide contingency path for manual booking assistance
  - [ ] Test booking flow across devices and browsers
