...
<div class="relative inline-block">
	...
	{#if showTooltip}
		<div
			...
			class="absolute bottom-full left-1/2 z-50 -translate-x-1/2 transform rounded-md bg-gray-900 px-2 py-1 text-xs text-white shadow-lg dark:bg-gray-100 dark:text-gray-900"
